...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText edittext = (EditText) findViewById(R.id.chooseloc);
...
//                Toast.makeText(getApplicationContext(), cat, Toast.LENGTH_LONG).show();
    ...
    public void UploadImageFileToFirebaseStorage() {
        ...
        if (ImageName.getText().toString().trim().equalsIgnoreCase("")) {
            ImageName.setError("Please Enter Doctor Name");
            return;
        }
        if (btnchose.getText().toString().trim().equalsIgnoreCase("")) {
            btnchose.setError("Please Enter Doctor Location");
            return;
        }
        if (docaddres.getText().toString().trim().equalsIgnoreCase("")) {
            docaddres.setError("Please enter doctor Address");
            return;
        }
        if (doccont.getText().toString().trim().equalsIgnoreCase("")) {
            doccont.setError("Please Enter Doctor Contact Details");
            return;
        }
            ...
            storageReference2nd.putFile(FilePathUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(getApplicationContext(), "Doctor Added Successfully ", Toast.LENGTH_LONG).show();
                    ...
                    .addOnProgressListener(new OnProgressListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onProgress(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            // Setting progressDialog Title.
                            progressDialog.setTitle("Doctor is Adding...");
